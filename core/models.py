...
class Mcq(models.Model):
    ...
    a = models.TextField( blank=False)
    b = models.TextField( blank=False)
    c = models.TextField( blank=False)
    d = models.TextField( blank=False)
    correct = models.CharField(max_length=255, blank=False, choices=(("a", a), ("b", b), ("c", c), ("d", d) ))
    author = models.CharField(max_length=255, blank=True,null=True)
    authors_note = models.CharField(max_length=255, blank=True,null=True)
